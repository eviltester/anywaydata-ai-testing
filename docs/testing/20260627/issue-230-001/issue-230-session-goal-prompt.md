...
- Main append-only sequential log: `issue-999-test-log.md`
- Main report that can be refined during the session: `issue-999-test-report.md`
- Final PDF export: `issue-999-test-report.pdf`
